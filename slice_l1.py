...
from channel_models import SINRSelectiveFading
...
class BaseSlice:
    """ BaseSlice pseudo interface

    """
    def __init__(self, n_prbs: int, slices_ran: List[Union[SliceRANmMTC, SliceRANeMBB]], slice_type: str, slice_id: str):
        self.n_prbs = n_prbs
...
class SliceL1mMTC(BaseSlice):
    ''' 
    Layer 1 functionality for mMTC slices. It can multiplex several mMTC RAN slices .
    '''
    def __init__(self, n_prbs, slices_ran: List[SliceRANmMTC], slice_id: str):
        super().__init__(n_prbs, slices_ran, 'mMTC', slice_id)
        self.reset()
...
class SliceL1eMBB(BaseSlice):
    ''' 
    Layer 1 functionality for eMBB slices. It can multiplex several eMBB slices.
    '''
    def __init__(self, rng, snr_generator: SINRSelectiveFading, n_prbs: int, slices_ran: List[SliceRANeMBB], scheduler: ProportionalFair, slice_id: str):
        super().__init__(n_prbs, slices_ran, 'eMBB', slice_id)
        self.rng = rng
